...
//					System.out.println("Adding transaction " +  t.getTxHash());
	...
	private Sha256Hash skipDangerousBlock(Sha256Hash block){
		if(block.toString().equals("000000000000000002792ce1fdd61b7f0a269a12948ea482fd1ba7b5f932c2ac"))
			return new Sha256Hash("0000000000000000003bfc6c59756e7611322dbb824a0489b2b5311491d847e6");
		
		if(firstBlock.toString().equals("00000000000000000eed03d82db963e606c07c408e863e8a80e896ef1cf557c7"))
			return new Sha256Hash("00000000000000003606eaf825796e818e8b34cd2808eedb15feccc68b1aba68");
		
		if(firstBlock.toString().equals("0000000000000000052baa120e0e4eeb6af5b395b6ca684075428966c993928f"))
			return new Sha256Hash("00000000000000000aed9276e0421d920bcfe0a99f1308fc944ce8240b14f2c8");
		
		if(firstBlock.toString().equals("000000000000000007e31cc9995cade2cb5c42834f984d6db38f798dc57790d0"))
			return new Sha256Hash("0000000000000000096b41dd18c907e71a69ec29864ee24f97fefcdcda22d11e");
